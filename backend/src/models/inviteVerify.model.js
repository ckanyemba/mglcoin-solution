...
class InviteVerifyModel {
    tableName = 'invite_verify';
    ...
    create = async ({ email, invite_code }) => {
        try {
            const sql = `INSERT INTO ${this.tableName}
            (email, invite_code) VALUES (?,?)`;

            const result = await query(sql, [email, invite_code]);
...
module.exports = new InviteVerifyModel;